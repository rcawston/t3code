...
import {
  ...
  type RespondToThreadProposalInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    respondToProposal: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:respond-to-proposal",
      execute: (input: RespondToThreadProposalInput) => respondToThreadProposal(input),
      scheduler,
      concurrency,
    }),
